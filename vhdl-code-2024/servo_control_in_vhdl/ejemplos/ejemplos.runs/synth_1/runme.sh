...
HD_PWD='C:/repo/vhdl-code-2024/servo_control_in_vhdl/ejemplos/ejemplos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ejemplo3.tcl
