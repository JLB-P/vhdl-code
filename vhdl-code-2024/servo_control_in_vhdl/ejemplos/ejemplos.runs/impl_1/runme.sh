...
HD_PWD='C:/repo/vhdl-code-2024/servo_control_in_vhdl/ejemplos/ejemplos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ejemplo3.tcl -notrace
