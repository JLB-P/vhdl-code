...
HD_PWD='/home/jlb/repo/vhdl/sistema_combinacional/sistema_combinacional.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparador_4b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparador_4b.tcl
