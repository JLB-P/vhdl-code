...
HD_PWD='C:/repo/my-vhdl-code/vga_distram/vga_distram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_distram_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_distram_top.tcl -notrace
