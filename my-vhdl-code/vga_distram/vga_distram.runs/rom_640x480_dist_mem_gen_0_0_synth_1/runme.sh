...
HD_PWD='C:/repo/my-vhdl-code/vga_distram/vga_distram.runs/rom_640x480_dist_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_640x480_dist_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_640x480_dist_mem_gen_0_0.tcl
