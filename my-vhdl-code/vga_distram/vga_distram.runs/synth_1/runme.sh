...
HD_PWD='C:/repo/my-vhdl-code/vga_distram/vga_distram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_distram_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_distram_top.tcl
