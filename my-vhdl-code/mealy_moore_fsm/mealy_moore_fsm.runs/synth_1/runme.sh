...
HD_PWD='C:/repo/my-vhdl-code/mealy_moore_fsm/mealy_moore_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mealy_moore_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mealy_moore_fsm.tcl
